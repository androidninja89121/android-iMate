...
import com.tieyouin.model.Conversation;
...
public class Chat extends CustomFragment
{
	...
	private void sendMessage()
	{
		...
		convList.add(new Conversation(s, "12:00 AM", true));
	...
	/**
	 * This method currently loads a dummy list of conversations. You can write
	 * the actual implementation of loading conversations.
	 */
	private void loadConversationList()
	{
		convList = new ArrayList<Conversation>();
		convList.add(new Conversation("hi there...", "12:45 AM", true));
